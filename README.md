...
```
  *Структура Point упакована в 64-битное значение (i64), так как состоит из двух i32.
  *Вызов printPoint осуществляется передачей структуры по значению — через один регистр (i64).
